...
class AddTransaction {
  ...
  Future<Either<Failure, void>> call({required TransactionEntity transaction}) => 
      _repo.addTransaction(transaction: transaction);
}
...
class UpdateTransaction {
  final ExpenseRepository _repo = getIt<ExpenseRepository>();
  Future<Either<Failure, void>> call({required TransactionEntity transaction}) => 
      _repo.updateTransaction(transaction: transaction);
}
